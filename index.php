  ...
  <div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner border border-dark rounded">
      <div class="carousel-item active">
        <div class="row g-0">
          <div class="col-md-6">
            <img src="https://miro.medium.com/max/2000/1*qcUfxpIdyX4cLquq8xbapQ.jpeg" class="img-fluid rounded">
          </div>
          <div class="col-md-6">
          <div class="card-body ">
      ...
      <div class="carousel-item">
        <div class="row g-0">
          <div class="col-md-6">
            <img src="https://source.unsplash.com/M6eWvLb2EYY/1600x900" class="img-fluid rounded">
          </div>
          <div class="col-md-6">
          <div class="card-body">
        <h5 class="text-center">CARBON FOOTPRINT</h5>
...
<div class="card text-center">
  ...
  <div class="card-body">
    <h5 class="card-title">CALCULATE YOUR CARBON EMISSION</h5>
